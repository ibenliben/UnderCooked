...
pattyraw_img = pg.image.load("assets/burgerpattyraw.jpg").convert_alpha()
pattycooked_img = pg.image.load("assets/burgerpattycooked.jpg").convert_alpha()
cabbage_img = pg.image.load("assets/cabbage.png").convert_alpha()
leaf_img = pg.image.load("assets/lettuceleaf.jpg").convert_alpha()
...
pattycooked_img = pg.transform.scale(beef_img,(40, 40))
pattyraw_img = pg.transform.scale(beef_img,(40, 40))

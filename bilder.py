...
player1_r = pg.transform.scale(player1_r, (PLAYER_HEIGHT, 1200/(975/PLAYER_HEIGHT)))
player2_r = pg.transform.scale(player2_r, (PLAYER_HEIGHT, 1200/(975/PLAYER_HEIGHT)))
